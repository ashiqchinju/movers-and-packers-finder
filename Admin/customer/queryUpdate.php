...
<ol class="breadcrumb bg-transparent">
    ...
    <li class="breadcrumb-item">
        <a href="customerQueries.php">Customer Queries</a>
    </li>
...
if(isset($_POST['update'])){
    ...
    echo "<script>window.location.href='customerQueries.php'</script>";
}
?>
...
if(isset($_POST['delete'])){
	...
	$delete="delete from cquery_tb where id='$id'";
