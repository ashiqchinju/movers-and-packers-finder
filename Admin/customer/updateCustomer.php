...
<ol class="breadcrumb bg-transparent">
    ...
    <li class="breadcrumb-item active" id="mini">Update Customer</li>
</ol>
...
if(isset($_POST['update'])){
	...
	$update="update creg_tb set  fname='$name',uname='$username',email='$email',phone='$phone',adhaar='$adhaar',gender='$gender',dob='$dob',district='$district', taluk='$taluk', address='$address' where id='$id'";
