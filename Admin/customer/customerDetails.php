...
<ol class="breadcrumb bg-transparent">
    ...
    <li class="breadcrumb-item active" id="mini">Customer Details</li>
</ol>
</div>
...
<td><a href="updateCustomer.php?id=<?php echo $id; ?>">Update</a>&nbsp;/&nbsp;<a href="deleteCustomer.php?id=<?php echo $id;?>">Delete</a></td>
</tr>
<?php
										}
									}
