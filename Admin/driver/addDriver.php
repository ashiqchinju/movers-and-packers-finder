...
if(isset($_POST['submit']))
{
     ...
     $dl=$_POST['dl'];
	  ...
	  if($exe->num_rows>0){
		...
		$insert="insert into dreg_tb (fname,uname,email,phone,adhaar,gender,dob,district,taluk,address,veh_type,dl_number) values ('$user_name','$user_uname','$user_email','$user_mobile','$user_adhaar','$user_gender','$user_dob','$user_district','$user_taluk','$user_adrs','$vtype','$dl')";
