...
if(isset($_POST['submit']))
{
	 ...
	 $user_adrs=$_POST['address'];
	  ...
	  if($exe->num_rows>0){
		...
		$insert="insert into creg_tb (fname,uname,email,phone,adhaar,gender,dob,district,taluk,address,password) values ('$user_name','$user_uname','$user_email','$user_mobile','$user_adhaar','$user_gender','$user_dob','$user_district','$user_taluk','$user_adrs','$user_password')";
...
<body style="background-image: url('images/customer.jpg'); background-repeat:no-repeat; background-size:100% 230vh;">
          ...
          <ul>
            ...
            <li class="drop-down active"><a href="">Sign Up</a>
              <ul>
                ...
                <li class="active"><a href="customerReg.php">Customer</a></li>
              </ul>
            </li>
...
<h1 class="mt-4 mb-3 text-dark"> <small>Customer Register</small> </h1>
...
<div class="row align-items-center justify-content-center">	 
    ...
    <h4 class="text text-center alert bg-primary" style="color:white">Customer Registration</h4>
    <?php
		if($adhaarError!=""){
			echo $adhaarError;
		}
