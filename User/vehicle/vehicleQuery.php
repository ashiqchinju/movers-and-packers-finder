...
if(!$_SESSION['email']){
     header("location:../vehicleLogin.php"); 
     }
if(isset($_POST['submit']))
{
     ...
     $message=$_POST['message'];
        $insert="insert into vquery_tb (name,email,adhaar,message) values ('$name','$email','$adhaar','$message')";
...
$select="select * from voreg_tb where email='$email'";
