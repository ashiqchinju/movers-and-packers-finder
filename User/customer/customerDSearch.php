...
<ol class="breadcrumb bg-transparent">
    ...
    <li class="breadcrumb-item active" id="mini">Driver Search</li>
</ol> 
    ...
    <table class="display table-active table-dark table-bordered" width="100%">
		<thead>
			<tr class="text-capitalize ">
				...
				<th class="text-capitalize">d l number</th>
			</tr>
		</thead>
		<tbody>
<?php 
...
$check="select * from dreg_tb where district='$search1' and taluk='$search2' and veh_type='$search3'";
$ch=$conn->query($check);
if($ch->num_rows>0){
    $total=0;
...
<td class="text-uppercase"><?php echo $row['fname']; ?></td>
